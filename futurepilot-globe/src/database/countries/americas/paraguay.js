...
const cities = [
  defineCity({
    id: "paraguay-ciudad-del-este",
    name: "Ciudad del Este",
    region: "Ciudad del Este (Alto Paraná)",
    coordinates: { lat: -25.5163, lng: -54.6111 },
    statistics: { population: "~300.000 habitantes", safety: "Moderada", weather: "13°C a 33°C", language: "Español / Guaraní", currency: "Guaraní (PYG)", internetSpeed: "~65 Mbps", qualityOfLife: "Media", studentSatisfaction: "Alta" },
    isCapital: false,
    countryId,
    countryName,
    universities: [],
  ...
  defineCity({
    ...
    statistics: { population: "~2.300.000 habitantes (Gran Asunción)", safety: "Moderada - Alta", weather: "12°C a 35°C", language: "Español / Guaraní", currency: "Guaraní (PYG)", internetSpeed: "~75 Mbps", qualityOfLife: "Media - Alta", studentSatisfaction: "Muy alta" },
    isCapital: true,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~130.000 habitantes", safety: "Muy alta", weather: "11°C a 32°C", language: "Español / Guaraní", currency: "Guaraní (PYG)", internetSpeed: "~60 Mbps", qualityOfLife: "Alta", studentSatisfaction: "Alta" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~120.000 habitantes (Coronel Oviedo)", safety: "Alta", weather: "12°C a 33°C", language: "Español / Guaraní", currency: "Guaraní (PYG)", internetSpeed: "~50 Mbps", qualityOfLife: "Media - Alta", studentSatisfaction: "Media - Alta" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~85.000 habitantes (Concepción)", safety: "Alta", weather: "14°C a 35°C", language: "Español / Guaraní", currency: "Guaraní (PYG)", internetSpeed: "~45 Mbps", qualityOfLife: "Media", studentSatisfaction: "Media - Alta" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
