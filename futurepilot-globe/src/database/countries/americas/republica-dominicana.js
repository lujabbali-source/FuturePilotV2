...
const cities = [
  defineCity({
    ...
    statistics: { population: "~3.300.000 habitantes (Área Metropolitana)", safety: "Moderada", weather: "21°C a 32°C", language: "Español", currency: "Peso dominicano (DOP)", internetSpeed: "~75 Mbps", qualityOfLife: "Media - Alta", studentSatisfaction: "Sobresaliente" },
    isCapital: true,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~700.000 habitantes", safety: "Moderada - Alta", weather: "20°C a 33°C", language: "Español", currency: "Peso dominicano (DOP)", internetSpeed: "~70 Mbps", qualityOfLife: "Alta", studentSatisfaction: "Muy alta" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~220.000 habitantes (La Romana)", safety: "Alta", weather: "22°C a 32°C", language: "Español", currency: "Peso dominicano (DOP)", internetSpeed: "~65 Mbps", qualityOfLife: "Media - Alta", studentSatisfaction: "Alta" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~250.000 habitantes (La Vega)", safety: "Alta", weather: "19°C a 32°C", language: "Español", currency: "Peso dominicano (DOP)", internetSpeed: "~60 Mbps", qualityOfLife: "Media - Alta", studentSatisfaction: "Alta" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~280.000 habitantes (San Cristóbal)", safety: "Moderada", weather: "21°C a 33°C", language: "Español", currency: "Peso dominicano (DOP)", internetSpeed: "~55 Mbps", qualityOfLife: "Media", studentSatisfaction: "Media - Alta" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
