...
export default defineCity({
    ...
    breakdown: {
        ...
        student: [{"label": {"es": "Costo esencial total del estudiante", "en": "Total essential student cost"}, "amount": {"min": 350, "max": 500, "currency": "USD"}}, {"label": {"es": "En qué consiste", "en": "Composition"}, "note": "Covers shared room near Universidad del Norte or Uniatlántico, groceries, local bus."}],
    },
});
