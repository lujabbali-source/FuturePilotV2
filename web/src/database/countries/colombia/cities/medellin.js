...
export default defineCity({
    ...
    breakdown: {
        ...
        student: [{"label": {"es": "Costo esencial total del estudiante", "en": "Total essential student cost"}, "amount": {"min": 1600000, "max": 2300000, "currency": "COP"}}, {"label": {"es": "En qué consiste", "en": "Composition"}, "note": "Shared flat near Robledo or Belén, public transport via Metro, home cooking."}],
    },
});
