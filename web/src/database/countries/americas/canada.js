...
const cities = [
  defineCity({
    ...
    statistics: { population: "~2.800.000 habitantes (Toronto)", safety: "Muy alta", weather: "-7°C a 27°C", language: "Inglés", currency: "Dólar canadiense (CAD)", internetSpeed: "~190 Mbps", qualityOfLife: "Muy alta", studentSatisfaction: "Sobresaliente" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~1.700.000 habitantes (Montreal)", safety: "Muy alta", weather: "-9°C a 26°C", language: "Francés / Inglés", currency: "Dólar canadiense (CAD)", internetSpeed: "~180 Mbps", qualityOfLife: "Muy alta", studentSatisfaction: "Sobresaliente" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~675.000 habitantes (Vancouver)", safety: "Muy alta", weather: "1°C a 23°C", language: "Inglés", currency: "Dólar canadiense (CAD)", internetSpeed: "~185 Mbps", qualityOfLife: "Muy alta", studentSatisfaction: "Sobresaliente" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~1.300.000 habitantes (Calgary)", safety: "Muy alta", weather: "-11°C a 24°C", language: "Inglés", currency: "Dólar canadiense (CAD)", internetSpeed: "~175 Mbps", qualityOfLife: "Muy alta", studentSatisfaction: "Sobresaliente" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~750.000 habitantes (Winnipeg)", safety: "Alta", weather: "-16°C a 26°C", language: "Inglés", currency: "Dólar canadiense (CAD)", internetSpeed: "~150 Mbps", qualityOfLife: "Alta", studentSatisfaction: "Muy alta" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~440.000 habitantes (Halifax)", safety: "Muy alta", weather: "-6°C a 23°C", language: "Inglés", currency: "Dólar canadiense (CAD)", internetSpeed: "~160 Mbps", qualityOfLife: "Muy alta", studentSatisfaction: "Muy alta" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
