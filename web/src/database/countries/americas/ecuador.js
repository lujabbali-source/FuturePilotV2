...
const cities = [
  defineCity({
    ...
    statistics: { population: "~2.000.000 habitantes", safety: "Moderada", weather: "9°C a 20°C", language: "Español", currency: "Dólar estadounidense (USD)", internetSpeed: "~75 Mbps", qualityOfLife: "Media - Alta", studentSatisfaction: "Muy alta" },
    isCapital: true,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~2.700.000 habitantes", safety: "Baja", weather: "22°C a 32°C", language: "Español", currency: "Dólar estadounidense (USD)", internetSpeed: "~70 Mbps", qualityOfLife: "Media", studentSatisfaction: "Alta" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~600.000 habitantes", safety: "Muy alta", weather: "10°C a 22°C", language: "Español", currency: "Dólar estadounidense (USD)", internetSpeed: "~80 Mbps", qualityOfLife: "Muy alta", studentSatisfaction: "Sobresaliente" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~350.000 habitantes (Ambato)", safety: "Alta", weather: "8°C a 19°C", language: "Español", currency: "Dólar estadounidense (USD)", internetSpeed: "~60 Mbps", qualityOfLife: "Alta", studentSatisfaction: "Alta" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~220.000 habitantes (Loja)", safety: "Alta", weather: "13°C a 24°C", language: "Español", currency: "Dólar estadounidense (USD)", internetSpeed: "~65 Mbps", qualityOfLife: "Alta", studentSatisfaction: "Alta" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~300.000 habitantes (Manta)", safety: "Moderada - Baja", weather: "22°C a 31°C", language: "Español", currency: "Dólar estadounidense (USD)", internetSpeed: "~55 Mbps", qualityOfLife: "Media", studentSatisfaction: "Media - Alta" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~200.000 habitantes (Ibarra)", safety: "Alta", weather: "11°C a 23°C", language: "Español", currency: "Dólar estadounidense (USD)", internetSpeed: "~60 Mbps", qualityOfLife: "Alta", studentSatisfaction: "Alta" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~40.000 habitantes (Puyo)", safety: "Muy alta", weather: "18°C a 28°C", language: "Español", currency: "Dólar estadounidense (USD)", internetSpeed: "~45 Mbps", qualityOfLife: "Media - Alta", studentSatisfaction: "Media" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
