...
const cities = [
  defineCity({
    ...
    statistics: { population: "~21.800.000 habitantes", safety: "Moderada", weather: "8°C a 26°C", language: "Español", currency: "Peso mexicano (MXN)", internetSpeed: "~110 Mbps", qualityOfLife: "Alta", studentSatisfaction: "Sobresaliente" },
    isCapital: true,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~5.300.000 habitantes (Área Metropolitana)", safety: "Moderada - Alta", weather: "10°C a 36°C", language: "Español", currency: "Peso mexicano (MXN)", internetSpeed: "~120 Mbps", qualityOfLife: "Muy alta", studentSatisfaction: "Sobresaliente" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~5.200.000 habitantes", safety: "Moderada", weather: "11°C a 31°C", language: "Español", currency: "Peso mexicano (MXN)", internetSpeed: "~105 Mbps", qualityOfLife: "Muy alta", studentSatisfaction: "Sobresaliente" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~3.200.000 habitantes (Área Metropolitana)", safety: "Moderada - Alta", weather: "8°C a 26°C", language: "Español", currency: "Peso mexicano (MXN)", internetSpeed: "~90 Mbps", qualityOfLife: "Alta", studentSatisfaction: "Sobresaliente" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~1.500.000 habitantes (Querétaro)", safety: "Muy alta", weather: "9°C a 29°C", language: "Español", currency: "Peso mexicano (MXN)", internetSpeed: "~100 Mbps", qualityOfLife: "Muy alta", studentSatisfaction: "Sobresaliente" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~1.200.000 habitantes", safety: "Muy alta", weather: "20°C a 36°C", language: "Español", currency: "Peso mexicano (MXN)", internetSpeed: "~85 Mbps", qualityOfLife: "Muy alta", studentSatisfaction: "Muy alta" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~2.100.000 habitantes (Tijuana)", safety: "Moderada - Baja", weather: "10°C a 27°C", language: "Español", currency: "Peso mexicano (MXN)", internetSpeed: "~95 Mbps", qualityOfLife: "Media - Alta", studentSatisfaction: "Alta" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
