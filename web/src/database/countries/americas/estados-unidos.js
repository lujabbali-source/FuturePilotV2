...
const cities = [
  defineCity({
    ...
    statistics: { population: "~8.500.000 habitantes (NYC) / ~680.000 (Boston)", safety: "Alta", weather: "-3°C a 29°C", language: "Inglés", currency: "Dólar estadounidense (USD)", internetSpeed: "~220 Mbps", qualityOfLife: "Muy alta", studentSatisfaction: "Sobresaliente" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~3.800.000 habitantes (Los Ángeles)", safety: "Moderada - Alta", weather: "10°C a 28°C", language: "Inglés / Español", currency: "Dólar estadounidense (USD)", internetSpeed: "~230 Mbps", qualityOfLife: "Muy alta", studentSatisfaction: "Sobresaliente" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~2.300.000 habitantes (Houston) / ~1.000.000 (Austin)", safety: "Alta", weather: "7°C a 36°C", language: "Inglés / Español", currency: "Dólar estadounidense (USD)", internetSpeed: "~210 Mbps", qualityOfLife: "Muy alta", studentSatisfaction: "Sobresaliente" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~2.700.000 habitantes (Chicago)", safety: "Moderada", weather: "-6°C a 29°C", language: "Inglés", currency: "Dólar estadounidense (USD)", internetSpeed: "~200 Mbps", qualityOfLife: "Alta", studentSatisfaction: "Sobresaliente" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~450.000 habitantes (Miami) / ~500.000 (Atlanta)", safety: "Moderada - Alta", weather: "16°C a 33°C", language: "Inglés / Español", currency: "Dólar estadounidense (USD)", internetSpeed: "~210 Mbps", qualityOfLife: "Alta", studentSatisfaction: "Sobresaliente" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
  ...
  defineCity({
    ...
    statistics: { population: "~740.000 habitantes (Seattle)", safety: "Alta", weather: "2°C a 26°C", language: "Inglés", currency: "Dólar estadounidense (USD)", internetSpeed: "~225 Mbps", qualityOfLife: "Muy alta", studentSatisfaction: "Sobresaliente" },
    isCapital: false,
    countryId,
    countryName,
    universities: [
