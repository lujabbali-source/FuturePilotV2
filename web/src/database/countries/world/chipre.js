...
const cities = [
    ...
    defineCity({
      id: "chipre-kyrenia",
      name: "Kyrenia",
      coordinates: {"lat": 35.33634, "lng": 33.31729},
      isCapital: false,
      universityCount: 4,
      statistics: { population: 26701 },
      countryId,
      countryName,
    }),
    defineCity({
    ...
    defineCity({
      id: "chipre-morfou",
      name: "Mórfou",
      coordinates: {"lat": 35.19869, "lng": 32.99338},
      isCapital: false,
      universityCount: 2,
      statistics: { population: 24070 },
      countryId,
      countryName,
    }),
    defineCity({
    ...
    defineCity({
      id: "chipre-famagusta",
      name: "Famagusta",
      coordinates: {"lat": 35.12489, "lng": 33.94135},
      isCapital: false,
      universityCount: 2,
      statistics: { population: 42526 },
      countryId,
      countryName,
    }),
    defineCity({
