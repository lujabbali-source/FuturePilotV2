// San Vicente y Granadinas — importado, no curado.
//
...
export default defineCountry({
  ...
  cities: [],
  // Las universidades no van aqui: viven en ./universities/san-vicente-y-granadinas.js
  // y se cargan solo al abrir el pais (ver getNationalUniversities).
  universityCount: 1,
  aliases: ["saint-vincent-and-the-grenadines", "san-vicente-y-granadinas"],
