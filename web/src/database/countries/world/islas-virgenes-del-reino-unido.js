// Islas Vírgenes del Reino Unido — importado, no curado.
//
...
export default defineCountry({
  id: "islas-virgenes-del-reino-unido",
  ...
  cities: [],
  // Las universidades no van aqui: viven en ./universities/islas-virgenes-del-reino-unido.js
  // y se cargan solo al abrir el pais (ver getNationalUniversities).
  universityCount: 1,
  aliases: ["british-virgin-islands", "islas-virgenes-del-reino-unido"],
