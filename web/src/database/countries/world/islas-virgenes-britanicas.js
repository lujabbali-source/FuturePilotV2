// Islas Vírgenes Británicas — importado, no curado.
//
...
const countryId = "islas-virgenes-britanicas";
const countryName = "Islas Vírgenes Británicas";
...
export default defineCountry({
  ...
  population: 39732,
  cities,
  // Las universidades no van aqui: viven en ./universities/islas-virgenes-britanicas.js
  // y se cargan solo al abrir el pais (ver getNationalUniversities).
  universityCount: 1,
  aliases: ["british-virgin-islands", "islas-virgenes-britanicas"],
