...
const cities = [
    ...
    defineCity({
      id: "argelia-setif",
      name: "Sétif",
      coordinates: {"lat": 36.19112, "lng": 5.41373},
      isCapital: false,
      universityCount: 3,
      statistics: { population: 252127 },
      countryId,
      countryName,
    }),
    defineCity({
    ...
    defineCity({
      id: "argelia-annaba",
      name: "Annaba",
      coordinates: {"lat": 36.9, "lng": 7.76667},
      isCapital: false,
      universityCount: 2,
      statistics: { population: 342703 },
      countryId,
      countryName,
    }),
    defineCity({
    ...
    defineCity({
      id: "argelia-tiaret",
      name: "Tiaret",
      coordinates: {"lat": 35.37103, "lng": 1.31699},
      isCapital: false,
      universityCount: 2,
      statistics: { population: 178915 },
      countryId,
      countryName,
    }),
    defineCity({
    ...
    defineCity({
      id: "argelia-m-sila",
      name: "M'Sila",
      coordinates: {"lat": 35.70889, "lng": 4.53722},
      isCapital: false,
      universityCount: 2,
      statistics: { population: 132975 },
      countryId,
      countryName,
    }),
    defineCity({
    ...
    defineCity({
      id: "argelia-cherchell",
      name: "Cherchell",
      coordinates: {"lat": 36.605, "lng": 2.19083},
      isCapital: false,
      universityCount: 2,
      statistics: { population: 34372 },
      countryId,
      countryName,
    }),
    defineCity({
