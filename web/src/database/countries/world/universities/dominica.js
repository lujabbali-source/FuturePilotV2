// Universidades de Dominica. Generado; no editar a mano.
...
export default [
    defineUniversity({
      id: "dominica-dominica-state-college",
    ...
    defineUniversity({
      id: "dominica-new-world-university",
    ...
    defineUniversity({
      id: "dominica-ross-university-caribbean-school-of-medicine",
      name: "Ross University Caribbean School of Medicine",
      cityId: null,
      website: "http://www.rossu.edu/",
      // La fuente abierta no dice si es publica o privada.
      // Se queda en null: una etiqueta adivinada se ve igual
      // que una cierta, y por eso es peor que ninguna.
      type: null,
