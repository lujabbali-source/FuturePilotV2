// Universidades de República Checa. Generado; no editar a mano.
...
export default [
    defineUniversity({
      id: "republica-checa-academy-of-performing-arts-film-and-tv-fakulty",
    ...
    defineUniversity({
      id: "republica-checa-anglo-american-university",
    ...
    defineUniversity({
      id: "republica-checa-brno-university-of-technology",
    ...
    defineUniversity({
      id: "republica-checa-cevro-institut-college",
    ...
    defineUniversity({
      id: "republica-checa-charles-university-prague",
    ...
    defineUniversity({
      id: "republica-checa-czech-technical-university-of-prague",
    ...
    defineUniversity({
      id: "republica-checa-czech-university-of-agriculture-prague",
    ...
    defineUniversity({
      id: "republica-checa-institute-of-technology-and-business-vste",
      name: "Institute of Technology and Business (VŠTE)",
      cityId: null,
    ...
    defineUniversity({
      id: "republica-checa-masaryk-university",
    ...
    defineUniversity({
      id: "republica-checa-mendel-university-of-agriculture-and-forestry",
      name: "Mendel University of Agriculture and Forestry",
      cityId: null,
      website: "https://www.mendelu.cz/",
      // La fuente abierta no dice si es publica o privada.
      // Se queda en null: una etiqueta adivinada se ve igual
      // que una cierta, y por eso es peor que ninguna.
      type: null,
    ...
    defineUniversity({
      id: "republica-checa-palacky-university-olomouc",
    ...
    defineUniversity({
      id: "republica-checa-prague-college",
      name: "Prague College",
      cityId: null,
    ...
    defineUniversity({
      id: "republica-checa-prague-institute-of-chemical-technology",
    ...
    defineUniversity({
      id: "republica-checa-prague-international-university",
    ...
    defineUniversity({
      id: "republica-checa-silesian-university",
    ...
    defineUniversity({
      id: "republica-checa-stredni-prumyslova-skola-mlada-boleslav",
      name: "Střední průmyslová škola Mladá Boleslav",
      cityId: null,
      website: "https://spsmb.cz/",
      // La fuente abierta no dice si es publica o privada.
      // Se queda en null: una etiqueta adivinada se ve igual
      // que una cierta, y por eso es peor que ninguna.
      type: null,
    ...
    defineUniversity({
      id: "republica-checa-technical-university-of-liberec",
    ...
    defineUniversity({
      id: "republica-checa-technical-university-of-mining-and-metallurgy-ostrava",
    ...
    defineUniversity({
      id: "republica-checa-tiffin-university-prague",
    ...
    defineUniversity({
      id: "republica-checa-tomas-bata-university-in-zlin",
    ...
    defineUniversity({
      id: "republica-checa-university-of-economics-prague",
    ...
    defineUniversity({
      id: "republica-checa-university-of-education-hradec-kralove",
    ...
    defineUniversity({
      id: "republica-checa-university-of-jan-evangelista-purkyne",
    ...
    defineUniversity({
      id: "republica-checa-university-of-new-york-in-prague",
    ...
    defineUniversity({
      id: "republica-checa-university-of-northern-virginia-prague-campus",
    ...
    defineUniversity({
      id: "republica-checa-university-of-ostrava",
    ...
    defineUniversity({
      id: "republica-checa-university-of-pardubice",
    ...
    defineUniversity({
      id: "republica-checa-university-of-south-bohemia",
    ...
    defineUniversity({
      id: "republica-checa-university-of-veterinary-and-pharmaceutical-science",
    ...
    defineUniversity({
      id: "republica-checa-university-of-west-bohemia",
