...
const cities = [
    ...
    defineCity({
      id: "rumania-constanta",
      name: "Constanţa",
      coordinates: {"lat": 44.18073, "lng": 28.63432},
      isCapital: false,
      universityCount: 3,
      statistics: { population: 317832 },
      countryId,
      countryName,
    }),
    defineCity({
      id: "rumania-brasov",
      name: "Braşov",
      coordinates: {"lat": 45.64861, "lng": 25.60613},
      isCapital: false,
      universityCount: 2,
      statistics: { population: 253200 },
      countryId,
      countryName,
    }),
    defineCity({
    ...
    defineCity({
      id: "rumania-targoviste",
      name: "Târgovişte",
      coordinates: {"lat": 44.92543, "lng": 25.4567},
      isCapital: false,
      universityCount: 2,
      statistics: { population: 66965 },
      countryId,
      countryName,
    }),
    defineCity({
      id: "rumania-resita",
      name: "Reşiţa",
      coordinates: {"lat": 45.30083, "lng": 21.88917},
      isCapital: false,
      universityCount: 2,
      statistics: { population: 81228 },
      countryId,
      countryName,
    }),
    defineCity({
