...
const cities = [
    ...
    defineCity({
      id: "grecia-thessaloniki",
      name: "Thessaloníki",
      coordinates: {"lat": 40.64072, "lng": 22.93493},
      isCapital: false,
      universityCount: 3,
      statistics: { population: 317778 },
      countryId,
      countryName,
    }),
    defineCity({
    ...
    defineCity({
      id: "grecia-agrinio",
      name: "Agrínio",
      coordinates: {"lat": 38.62139, "lng": 21.40778},
      isCapital: false,
      universityCount: 2,
      statistics: { population: 46899 },
      countryId,
      countryName,
    }),
    defineCity({
