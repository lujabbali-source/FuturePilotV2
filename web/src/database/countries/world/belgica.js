...
const cities = [
    ...
    defineCity({
      id: "belgica-brussels",
      name: "Brussels",
      coordinates: {"lat": 50.85045, "lng": 4.34878},
      isCapital: true,
      universityCount: 5,
      statistics: { population: 1019022 },
      countryId,
      countryName,
    }),
    defineCity({
    ...
    defineCity({
      id: "belgica-woluwe-saint-lambert",
      name: "Woluwe-Saint-Lambert",
      coordinates: {"lat": 50.84389, "lng": 4.42912},
      isCapital: false,
      universityCount: 1,
      statistics: { population: 56584 },
      countryId,
      countryName,
    }),
    defineCity({
      id: "belgica-tournai",
      name: "Tournai",
      coordinates: {"lat": 50.60715, "lng": 3.38932},
      isCapital: false,
      universityCount: 1,
      statistics: { population: 69554 },
      countryId,
      countryName,
    }),
    defineCity({
