...
const cities = [
    ...
    defineCity({
      id: "arabia-saudi-makkah",
      name: "Makkah",
      coordinates: {"lat": 21.42664, "lng": 39.82563},
      isCapital: false,
      universityCount: 1,
      statistics: { population: 1578722 },
      countryId,
      countryName,
    }),
    defineCity({
    ...
    defineCity({
      id: "arabia-saudi-buraydah",
      name: "Buraydah",
      coordinates: {"lat": 26.32599, "lng": 43.97497},
      isCapital: false,
      universityCount: 2,
      statistics: { population: 745353 },
      countryId,
      countryName,
    }),
    defineCity({
    ...
    defineCity({
      id: "arabia-saudi-al-hufuf",
      name: "Al Hufūf",
      coordinates: {"lat": 25.36467, "lng": 49.58764},
      isCapital: false,
      universityCount: 1,
      statistics: { population: 293179 },
      countryId,
      countryName,
    }),
    defineCity({
