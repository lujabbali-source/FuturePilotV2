...
const cities = [
    ...
    defineCity({
      id: "finlandia-jyvaskyla",
      name: "Jyväskylä",
      coordinates: {"lat": 62.24147, "lng": 25.72088},
      isCapital: false,
      universityCount: 2,
      statistics: { population: 148744 },
      countryId,
      countryName,
    }),
    defineCity({
      id: "finlandia-joensuu",
      name: "Joensuu",
      coordinates: {"lat": 62.60118, "lng": 29.76316},
      isCapital: false,
      universityCount: 2,
      statistics: { population: 78398 },
      countryId,
      countryName,
    }),
    defineCity({
