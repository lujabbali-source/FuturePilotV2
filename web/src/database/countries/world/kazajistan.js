...
const cities = [
    ...
    defineCity({
      id: "kazajistan-kyzylorda",
      name: "Kyzylorda",
      coordinates: {"lat": 44.85278, "lng": 65.50917},
      isCapital: false,
      universityCount: 2,
      statistics: { population: 354800 },
      countryId,
      countryName,
    }),
    defineCity({
    ...
    defineCity({
      id: "kazajistan-taraz",
      name: "Taraz",
      coordinates: {"lat": 42.89799, "lng": 71.37334},
      isCapital: false,
      universityCount: 2,
      statistics: { population: 358153 },
      countryId,
      countryName,
    }),
    defineCity({
