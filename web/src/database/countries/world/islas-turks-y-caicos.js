// Islas Turks y Caicos — importado, no curado.
//
...
export default defineCountry({
  ...
  cities: [],
  // Las universidades no van aqui: viven en ./universities/islas-turks-y-caicos.js
  // y se cargan solo al abrir el pais (ver getNationalUniversities).
  universityCount: 1,
  aliases: ["islas-turks-y-caicos", "turks-and-caicos-islands"],
