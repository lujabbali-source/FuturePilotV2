...
const cities = [
    ...
    defineCity({
      id: "ghana-ashaiman",
      name: "Ashaiman",
      coordinates: {"lat": 5.69951, "lng": -0.03484},
      isCapital: false,
      universityCount: 7,
      statistics: { population: 190972 },
      countryId,
      countryName,
    }),
    defineCity({
    ...
    defineCity({
      id: "ghana-teshi-old-town",
      name: "Teshi Old Town",
      coordinates: {"lat": 5.58365, "lng": -0.10722},
      isCapital: false,
      universityCount: 2,
      statistics: { population: 144013 },
      countryId,
      countryName,
    }),
    defineCity({
    ...
    defineCity({
      id: "ghana-ahwiaa",
      name: "Ahwiaa",
      coordinates: {"lat": 6.76051, "lng": -1.59402},
      isCapital: false,
      universityCount: 2,
      statistics: { population: 32163 },
      countryId,
      countryName,
    }),
    defineCity({
