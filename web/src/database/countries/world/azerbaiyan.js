...
const cities = [
    ...
    defineCity({
      id: "azerbaiyan-lokbatan",
      name: "Lokbatan",
      coordinates: {"lat": 40.3256, "lng": 49.73376},
      isCapital: false,
      universityCount: 0,
      statistics: { population: 30694 },
      countryId,
      countryName,
    }),
    defineCity({
    ...
    defineCity({
      id: "azerbaiyan-naxc-van",
      name: "Naxçıvan",
      coordinates: {"lat": 39.20889, "lng": 45.41222},
      isCapital: false,
      universityCount: 2,
      statistics: { population: 97200 },
      countryId,
      countryName,
    }),
    defineCity({
      id: "azerbaiyan-ganja",
      name: "Ganja",
      coordinates: {"lat": 40.68157, "lng": 46.36134},
      isCapital: false,
      universityCount: 3,
      statistics: { population: 330663 },
      countryId,
      countryName,
    }),
    defineCity({
