...
const cities = [
    ...
    defineCity({
      id: "uzbekistan-nukus",
      name: "Nukus",
      coordinates: {"lat": 42.45861, "lng": 59.60576},
      isCapital: false,
      universityCount: 3,
      statistics: { population: 332500 },
      countryId,
      countryName,
    }),
    defineCity({
      id: "uzbekistan-tirmiz",
      name: "Tirmiz",
      coordinates: {"lat": 37.22417, "lng": 67.27833},
      isCapital: false,
      universityCount: 2,
      statistics: { population: 182800 },
      countryId,
      countryName,
    }),
    defineCity({
    ...
    defineCity({
      id: "uzbekistan-qo-qon",
      name: "Qo‘qon",
      coordinates: {"lat": 40.52861, "lng": 70.9425},
      isCapital: false,
      universityCount: 2,
      statistics: { population: 259700 },
      countryId,
      countryName,
    }),
    defineCity({
      id: "uzbekistan-namangan",
      name: "Namangan",
      coordinates: {"lat": 40.9983, "lng": 71.67257},
      isCapital: false,
      universityCount: 2,
      statistics: { population: 713220 },
      countryId,
      countryName,
    }),
    defineCity({
    ...
    defineCity({
      id: "uzbekistan-chirchiq",
      name: "Chirchiq",
      coordinates: {"lat": 41.46889, "lng": 69.58222},
      isCapital: false,
      universityCount: 2,
      statistics: { population: 162800 },
      countryId,
      countryName,
    }),
    defineCity({
    ...
    defineCity({
      id: "uzbekistan-andijon",
      name: "Andijon",
      coordinates: {"lat": 40.78338, "lng": 72.35067},
      isCapital: false,
      universityCount: 1,
      statistics: { population: 747800 },
      countryId,
      countryName,
    }),
];
