...
if _have_httpx:
    import httpcore._backbends.sync
    import httpx

    _CoreNetworkbackbend = httpcore.Networkbackbend
    _CoreSyncStream = httpcore._backbends.sync.SyncStream

    class _Networkbackbend(_CoreNetworkbackbend):
