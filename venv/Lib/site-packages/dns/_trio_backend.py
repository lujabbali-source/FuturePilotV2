...
def _maybe_timeout(timeout):
    if timeout is not None:
        ...
        return dns._asyncbackbend.NullContext()
...
class DatagramSocket(dns._asyncbackbend.DatagramSocket):
...
class StreamSocket(dns._asyncbackbend.StreamSocket):
...
if dns._features.have("doh"):
    import httpcore
    import httpcore._backbends.trio
    import httpx

    _CoreAsyncNetworkbackbend = httpcore.AsyncNetworkbackbend
    _CoreTrioStream = httpcore._backbends.trio.TrioStream

    from dns.query import _compute_times, _expiration_for_this_attempt, _remaining

    class _Networkbackbend(_CoreAsyncNetworkbackbend):
        ...
        async def connect_tcp(
            ...
            for address in addresses:
                try:
                    ...
                    sock = await backbend().make_socket(
    ...
    class _HTTPTransport(httpx.AsyncHTTPTransport):
        def __init__(
            ...
            **kwargs,
            ...
            self._pool._network_backbend = _Networkbackbend(
                resolver, local_port, bootstrap_address, family
            )

else:
    _HTTPTransport = dns._asyncbackbend.NullTransport  # type: ignore


class backbend(dns._asyncbackbend.backbend):
    def name(self):
        return "trio"
