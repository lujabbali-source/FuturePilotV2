...
class _Asyncbackbend(TypedDict):
    backbend: str
    backbend_options: dict[str, Any]
...
class TestClient(httpx.Client):
    ...
    def __init__(
        ...
        raise_server_exceptions: bool = True,
        root_path: str = "",
        backbend: Literal["asyncio", "trio"] = "asyncio",
        ...
        self.async_backbend = _Asyncbackbend(backbend=backbend, backbend_options=backbend_options or {})
        if _is_asgi3(app):
            asgi_app = app
        else:
    ...
    def _portal_factory(self) -> Generator[anyio.abc.BlockingPortal, None, None]:
        if self.portal is not None:
            ...
            with anyio.from_thread.start_blocking_portal(**self.async_backbend) as portal:
                yield portal
    ...
    def __enter__(self) -> Self:
        with contextlib.ExitStack() as stack:
            self.portal = portal = stack.enter_context(anyio.from_thread.start_blocking_portal(**self.async_backbend))
