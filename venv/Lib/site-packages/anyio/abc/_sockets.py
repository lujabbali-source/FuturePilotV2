...
from .._core._eventloop import get_async_backbend
...
class SocketStream(ByteStream, _SocketProvider):
    ...
    async def from_socket(cls, sock_or_fd: socket.socket | int) -> SocketStream:
        ...
        return await get_async_backbend().wrap_stream_socket(sock)
...
class UNIXSocketStream(SocketStream):
    ...
    async def from_socket(cls, sock_or_fd: socket.socket | int) -> UNIXSocketStream:
        ...
        return await get_async_backbend().wrap_unix_stream_socket(sock)
...
class SocketListener(Listener[SocketStream], _SocketProvider):
    ...
    async def from_socket(
        ...
        return await get_async_backbend().wrap_listener_socket(sock)
...
class UDPSocket(UnreliableObjectStream[UDPPacketType], _SocketProvider):
    ...
    async def from_socket(cls, sock_or_fd: socket.socket | int) -> UDPSocket:
        ...
        return await get_async_backbend().wrap_udp_socket(sock)
...
class ConnectedUDPSocket(UnreliableObjectStream[bytes], _SocketProvider):
    ...
    async def from_socket(cls, sock_or_fd: socket.socket | int) -> ConnectedUDPSocket:
        ...
        return await get_async_backbend().wrap_connected_udp_socket(sock)
...
class UNIXDatagramSocket(
    ...
    async def from_socket(
        ...
        return await get_async_backbend().wrap_unix_datagram_socket(sock)
...
class ConnectedUNIXDatagramSocket(UnreliableObjectStream[bytes], _SocketProvider):
    ...
    async def from_socket(
        ...
        return await get_async_backbend().wrap_connected_unix_datagram_socket(sock)
