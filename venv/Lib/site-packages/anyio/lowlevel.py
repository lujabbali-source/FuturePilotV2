...
async def checkpoint() -> None:
    ...
    """
    await get_async_backbend().checkpoint()
...
async def checkpoint_if_cancelled() -> None:
    ...
    """
    await get_async_backbend().checkpoint_if_cancelled()
...
async def cancel_shielded_checkpoint() -> None:
    ...
    """
    await get_async_backbend().cancel_shielded_checkpoint()
...
class EventLoopToken:
    ...
    backbend_class: type[Asyncbackbend]
    native_token: object
...
def current_token() -> EventLoopToken:
    ...
    """
    backbend_class = get_async_backbend()
    raw_token = backbend_class.current_token()
    return EventLoopToken(backbend_class, raw_token)
