...
from ..abc._eventloop import Asyncbackbend, StrOrBytesPath
...
class Triobackbend(Asyncbackbend):
    @classmethod
    def run(
        cls,
    ...
    async def run_sync_in_worker_thread(
        ...
        def wrapper() -> T_Retval:
            with claim_worker_thread(Triobackbend, token):
                return func(*args)

        token = Triobackbend.current_token()
