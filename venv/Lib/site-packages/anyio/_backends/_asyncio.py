        ...
        try:
            ...
            try:
                if self._tasks:
                    ...
                    # anyway
                    await AsyncIObackbend.cancel_shielded_checkpoint()
...
class WorkerThread(Thread):
    ...
    def __init__(
        ...
        self.idle_since = AsyncIObackbend.current_time()
        self.stopping = False
    ...
    def run(self) -> None:
        with claim_worker_thread(AsyncIObackbend, self.loop):
            while True:
                item = self.queue.get()
                if item is None:
...
class StreamReaderWrapper(abc.ByteReceiveStream):
    ...
    async def aclose(self) -> None:
        ...
        await AsyncIObackbend.checkpoint()
...
class StreamWriterWrapper(abc.ByteSendStream):
    ...
    async def send(self, item: bytes) -> None:
        await AsyncIObackbend.checkpoint_if_cancelled()
...
class AsyncIObackbend(Asyncbackbend):
    @classmethod
    def run(
        cls,
...
backbend_class = AsyncIObackbend
