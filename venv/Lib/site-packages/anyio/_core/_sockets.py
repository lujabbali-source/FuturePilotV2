...
from ._eventloop import get_async_backbend
...
async def connect_unix(path: str | bytes | PathLike[Any]) -> UNIXSocketStream:
    ...
    """
    path = os.fspath(path)
    return await get_async_backbend().connect_unix(path)
...
async def create_unix_listener(
    ...
    *,
    ...
    try:
        ...
        return get_async_backbend().create_unix_listener(raw_socket)
    except BaseException:
        raw_socket.close()
        raise
...
async def create_udp_socket(
    ...
    *,
    ...
    sock = await get_async_backbend().create_udp_socket(
...
async def create_unix_datagram_socket(
    *,
    ...
    return await get_async_backbend().create_unix_datagram_socket(raw_socket, None)
...
async def create_connected_unix_datagram_socket(
    ...
    *,
    ...
    return await get_async_backbend().create_unix_datagram_socket(
...
async def getaddrinfo(
    ...
    *,
    ...
    gai_res = await get_async_backbend().getaddrinfo(
...
def getnameinfo(sockaddr: IPSockAddrType, flags: int = 0) -> Awaitable[tuple[str, str]]:
    ...
    """
    return get_async_backbend().getnameinfo(sockaddr, flags)
...
def wait_socket_readable(sock: socket.socket) -> Awaitable[None]:
    ...
    """
    return get_async_backbend().wait_readable(sock.fileno())
...
def wait_socket_writable(sock: socket.socket) -> Awaitable[None]:
    ...
    This does **NOT** work on Windows when using the asyncio backbend with a proactor
    ...
    """
    return get_async_backbend().wait_writable(sock.fileno())
...
def wait_readable(obj: FileDescriptorLike) -> Awaitable[None]:
    ...
    On backbends where this functionality is not natively provided (asyncio
    ...
    """
    return get_async_backbend().wait_readable(obj)
...
def wait_writable(obj: FileDescriptorLike) -> Awaitable[None]:
    ...
    .. seealso:: See the documentation of :func:`wait_readable` for the definition of
       ``obj`` and notes on backbend compatibility.

    .. warning:: Don't use this on raw sockets that have been wrapped by any higher
        level constructs like socket streams!

    """
    return get_async_backbend().wait_writable(obj)
...
def notify_closing(obj: FileDescriptorLike) -> None:
    ...
    """
    get_async_backbend().notify_closing(obj)
